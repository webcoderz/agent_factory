...
from .types import Capability, Component, WorkflowSpec, StepSpec


@dataclass
class PlannerComponent:
    capability = Capability(name="planner_component", tags=("plan",), cost_hint=1, quality_hint=0.5, requires_model=False)
...
class MemoryComponent:
    capability = Capability(name="memory_component", tags=("memory",), cost_hint=1, quality_hint=0.5, requires_model=False)
...
class RepoSearchComponent:
    capability = Capability(name="repo_search_component", tags=("search_repo",), cost_hint=1, quality_hint=0.5, requires_model=False)
...
class SummarizeComponent:
    capability = Capability(name="summarize_component", tags=("summarize",), cost_hint=1, quality_hint=0.5, requires_model=False)
